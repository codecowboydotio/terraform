...
variable "servicename" { default = "svk-swapi-api4" }
variable "frontend_servicename" { default = "svk-swapi-frontend4" }
variable "manifest_app_name" { default = "svk-swapi-api4" }
variable "frontend_manifest_app_name" { default = "svk-swapi-frontend4" }
